...
def rk4(
    ...
    k1 = deterministic_cr3bp.eom(case, state, control, sigma)
    k2 = deterministic_cr3bp.eom(case, state + 0.5 * step_size * k1, control_mid, sigma_mid)
    k3 = deterministic_cr3bp.eom(case, state + 0.5 * step_size * k2, control_mid, sigma_mid)
    k4 = deterministic_cr3bp.eom(case, state + step_size * k3, control_end, sigma_end)
